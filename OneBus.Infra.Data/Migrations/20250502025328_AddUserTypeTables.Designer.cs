...
namespace OneBus.Infra.Data.Migrations
{
    ...
    [Migration("20250502025328_AddUserTypeTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneBus.Domain.Entities.Feature", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("OneBus.Domain.Entities.UserType", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("OneBus.Domain.Entities.UserTypeFeature", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
                    ...
                    b.Property<decimal>("FeatureId")
                        .HasColumnType("decimal(20,0)")
                        .HasColumnName("FuncionalidadeId");

                    b.Property<bool>("HasPermission")
                        .HasColumnType("bit")
                        .HasColumnName("TemPermissao");
                    ...
                    b.ToTable("TipoUsuarioFuncionalidade", (string)null);
                });
            ...
            modelBuilder.Entity("OneBus.Domain.Entities.User", b =>
                {
                    b.HasOne("OneBus.Domain.Entities.UserType", "UserType")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("OneBus.Domain.Entities.UserTypeFeature", b =>
                {
                    b.HasOne("OneBus.Domain.Entities.Feature", "Feature")
                        .WithMany("UserTypeFeatures")
