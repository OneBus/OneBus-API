...
namespace OneBus.API.Controllers
{
    ...
    public class BusOperationController : BaseController<BusOperation, CreateBusOperationDTO, ReadBusOperationDTO, UpdateBusOperationDTO, BaseFilter>
    {
        ...
        /// <summary>
        /// Habilitar operação de ônibus 
        /// </summary>
        /// <remarks>
        /// PUT para habilitar operação de ônibus 
        /// </remarks>
        /// <param name="id">Id da operação de ônibus</param>
        /// <param name="cancellationToken"></param>
        /// <returns>Operação de Ônibus habilitada</returns>
        /// <response code="200">Operação de Ônibus habilitada com sucesso</response>
        /// <response code="404">Operação de Ônibus não encontrada</response>
        ...
        /// <summary>
        /// Desabilitar operação de ônibus 
        /// </summary>
        /// <remarks>
