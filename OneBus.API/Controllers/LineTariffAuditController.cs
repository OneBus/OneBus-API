...
namespace OneBus.API.Controllers
{
    ...
    public class LineTariffAuditController : BaseController<LineTariffAudit, CreateLineTariffAuditDTO, ReadLineTariffAuditDTO, UpdateLineTariffAuditDTO, BaseFilter>
    {
        ...
        /// <summary>
        /// Habilitar auditoria de tarifa de linha 
        /// </summary>
        /// <remarks>
        /// PUT para habilitar auditoria de tarifa de linha
        /// </remarks>
        /// <param name="id">Id da auditoria de tarifa de linha</param>
        /// <param name="cancellationToken"></param>
        /// <returns>Auditoria de Tarifa de Linha habilitada</returns>
        /// <response code="200">Auditoria de Tarifa de Linha habilitada com sucesso</response>
        /// <response code="404">Auditoria de Tarifa de Linha não encontrada</response>
        ...
        /// <summary>
        /// Desabilitar auditoria de tarifa de linha
        /// </summary>
        /// <remarks>
