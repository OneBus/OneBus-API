...
namespace OneBus.Application.Interfaces.Services
{
        ...
        where TFilter    : BaseFilter
    {
        ...
        Task<Result<bool>> EnableAsync(ulong id, CancellationToken cancellationToken = default);

        Task<Result<bool>> DisableAsync(ulong id, CancellationToken cancellationToken = default);
    }
}
